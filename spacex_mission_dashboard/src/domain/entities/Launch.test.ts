import { Launch, LaunchConstructorParams } from './Launch';
...
describe('Launch Entity', () => {
  ...
  describe('Edge cases and data integrity', () => {
    ...
    //   const originalCrew = ['Astronaut 1', 'Astronaut 2'];
    //   const launch = createLaunch({ crew: originalCrew });

    //   // Modify the original array
    //   originalCrew.push('Astronaut 3');

    //   // Launch crew should remain unchanged
    //   expect(launch.crew).toEqual(['Astronaut 1', 'Astronaut 2']);
    //   expect(launch.crew).not.toEqual(originalCrew);
    // });
